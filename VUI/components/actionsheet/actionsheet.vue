<template>
  <div>
    <div class="weui-mask_transparent actionsheet__mask actionsheet__mask_show weui-animate-fade-in"
         v-show="currentValue && type === 'ios'" @click="currentValue = false"></div>
    <div class="weui-actionsheet weui-actionsheet_toggle weui-animate-slide-up" v-if="type === 'ios'" v-show="currentValue">
