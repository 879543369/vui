<template>
  <div class="vui-swipe" :style="{ height: height + 'px' }">
    <div class="vui-swipe-wrapper" ref="wrapper">
      <slot></slot>
    </div>
    <div class="vui-swipe-indicators" v-show="showIndicators">
      <div class="vui-swipe-indicator" v-for="(page, $index) in pages" :key="$index" :class="{ 'is-active': $index === index }"></div>
    </div>
  </div>
</template>
